...
class base_Model(nn.Module):
    def __init__(self, configs, device):
        ...
        self.conv_block1 = nn.Sequential(
            nn.Conv1d(configs.d_model, 32, kernel_size=3,
        ...
        self.conv_block2 = nn.Sequential(
            nn.Conv1d(32, configs.d_model, kernel_size=3, stride=1, bias=False, padding=1),
        ...
        self.output_layer = nn.Linear(configs.d_model, configs.d_model)
        self.project = nn.Linear(configs.d_model, configs.d_model, bias=False)
    ...
    def forward(self, x): 
        ...
        x = self.conv_block1(emb_temp.permute(0,2,1))
        ...
        rec_temp = self.project(output)
        
        enc_res  = hidden[:,:, :-self.d_res]
        enc_pri = hidden[:,:, -self.d_res:]
